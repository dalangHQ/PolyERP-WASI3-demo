...
_trampoline6.fnName = 'wasi:cli/exit@0.2.9#exit';
...
_trampoline7.fnName = 'wasi:io/poll@0.2.9#block';
...
_trampoline8.fnName = 'wasi:io/streams@0.2.9#subscribe';
...
_trampoline9.fnName = 'wasi:cli/stdin@0.2.9#getStdin';
...
_trampoline10.fnName = 'wasi:cli/stdout@0.2.9#getStdout';
...
_trampoline11.fnName = 'wasi:cli/stderr@0.2.9#getStderr';
...
_trampoline12.fnName = 'wasi:clocks/monotonic-clock@0.2.9#subscribeDuration';
let exports1;
let memory0;
let realloc0;
let realloc0Async;
...
_trampoline13.fnName = 'wasi:random/insecure-seed@0.2.9#insecureSeed';
...
_trampoline14.fnName = 'wasi:io/poll@0.2.9#poll';
...
_trampoline18.fnName = 'wasi:cli/environment@0.2.9#getEnvironment';
...
_trampoline19.fnName = 'wasi:cli/terminal-stdin@0.2.9#getTerminalStdin';
...
_trampoline20.fnName = 'wasi:cli/terminal-stdout@0.2.9#getTerminalStdout';
...
_trampoline21.fnName = 'wasi:cli/terminal-stderr@0.2.9#getTerminalStderr';
let exports2;
let postReturn0;
let postReturn0Async;
let postReturn1;
let postReturn1Async;
let inventory100ProcessOrdersBatch;

function processOrdersBatch(arg0) {
  var vec4 = arg0;
  var len4 = vec4.length;
  var result4 = realloc0(0, 0, 4, len4 * 28);
  for (let i = 0; i < vec4.length; i++) {
    const e = vec4[i];
    const base = result4 + i * 28;var {id: v0_0, itemId: v0_1, quantity: v0_2, userId: v0_3 } = e;
    ...
    dataView(memory0).setUint32(base + 12, len2, true);
    dataView(memory0).setUint32(base + 8, ptr2, true);
    dataView(memory0).setInt32(base + 16, toUint32(v0_2), true);
    
    var encodeRes = _utf8AllocateAndEncode(v0_3, realloc0, memory0);
    var ptr3= encodeRes.ptr;
    var len3 = encodeRes.len;
    
    dataView(memory0).setUint32(base + 24, len3, true);
    dataView(memory0).setUint32(base + 20, ptr3, true);
  }
  _debugLog('[iface="demo:poly-erp/inventory@1.0.0", function="process-orders-batch"][Instruction::CallWasm] enter', {
    funcName: 'process-orders-batch',
    paramCount: 2,
    async: false,
    postReturn: true,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'inventory100ProcessOrdersBatch',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'none',
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => inventory100ProcessOrdersBatch(result4, len4),
    });
  } catch (err) {
  ...
  for (let i = 0; i < len6; i++) {
    ...
    result6.push({
      itemId: result5,
      newStock: dataView(memory0).getInt32(base + 8, true) >>> 0,
    });
  }
  _debugLog('[iface="demo:poly-erp/inventory@1.0.0", function="process-orders-batch"][Instruction::Return]', {
    funcName: 'process-orders-batch',
    paramCount: 1,
    async: false,
    postReturn: true
  });
  task.resolve([result6]);
  const retCopy = result6;
...
let inventory100GetStock;

function getStock(arg0) {
  var vec1 = arg0;
  ...
  _debugLog('[iface="demo:poly-erp/inventory@1.0.0", function="get-stock"][Instruction::CallWasm] enter', {
    funcName: 'get-stock',
    paramCount: 2,
    async: false,
    postReturn: true,
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'inventory100GetStock',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'none',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => inventory100GetStock(result1, len1),
    });
  } catch (err) {
  ...
  _debugLog('[iface="demo:poly-erp/inventory@1.0.0", function="get-stock"][Instruction::Return]', {
    funcName: 'get-stock',
    paramCount: 1,
    async: false,
    postReturn: true
...
let inventory100GetMemoryStats;

function getMemoryStats() {
  _debugLog('[iface="demo:poly-erp/inventory@1.0.0", function="get-memory-stats"][Instruction::CallWasm] enter', {
    funcName: 'get-memory-stats',
    paramCount: 0,
    async: false,
    postReturn: false,
  });
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'inventory100GetMemoryStats',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'none',
    callingWasmExport: true,
  ...
  _debugLog('[iface="demo:poly-erp/inventory@1.0.0", function="get-memory-stats"][Instruction::Return]', {
    funcName: 'get-memory-stats',
    paramCount: 1,
    async: false,
    postReturn: false
  ...
  task.resolve([{
    linearMemoryBytes: BigInt.asUintN(64, BigInt(dataView(memory0).getBigInt64(ret + 0, true))),
    totalOrdersTracked: dataView(memory0).getInt32(ret + 8, true) >>> 0,
    dbEntries: dataView(memory0).getInt32(ret + 12, true) >>> 0,
    peakBatchSize: dataView(memory0).getInt32(ret + 16, true) >>> 0,
  }]);
  task.exit();
  return {
    linearMemoryBytes: BigInt.asUintN(64, BigInt(dataView(memory0).getBigInt64(ret + 0, true))),
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./inventory.core.wasm', import.meta.url));
    const module1 = base64Compile('');
    const module2 = base64Compile('AGFzbQEAAAABFwRgAX8AYAN/f38AYAJ/fwBgBH9/f38AAj0KAAEwAAAAATEAAQABMgACAAEzAAMAATQAAgABNQAAAAE2AAAAATcAAAABOAAAAAgkaW1wb3J0cwFwAQkJCQ8BAEEACwkAAQIDBAUGBwgALwlwcm9kdWNlcnMBDHByb2Nlc3NlZC1ieQENd2l0LWNvbXBvbmVudAcwLjI1Mi4w');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      ...
      'wasi:cli/terminal-stderr@0.2.0': {
        'get-terminal-stderr': exports0['8'],
      },
      'wasi:cli/terminal-stdin@0.2.0': {
        'get-terminal-stdin': exports0['6'],
      },
      'wasi:cli/terminal-stdout@0.2.0': {
        'get-terminal-stdout': exports0['7'],
      },
    ...
    postReturn0 = exports1['cabi_post_demo:poly-erp/inventory@1.0.0#process-orders-batch'];
    
    try {
      postReturn0Async = WebAssembly.promising(exports1['cabi_post_demo:poly-erp/inventory@1.0.0#process-orders-batch']);
    } catch(err) {
      postReturn0Async = exports1['cabi_post_demo:poly-erp/inventory@1.0.0#process-orders-batch'];
    }
    
    postReturn1 = exports1['cabi_post_demo:poly-erp/inventory@1.0.0#get-stock'];
    
    try {
      postReturn1Async = WebAssembly.promising(exports1['cabi_post_demo:poly-erp/inventory@1.0.0#get-stock']);
    } catch(err) {
      postReturn1Async = exports1['cabi_post_demo:poly-erp/inventory@1.0.0#get-stock'];
    }
    
    inventory100ProcessOrdersBatch = exports1['demo:poly-erp/inventory@1.0.0#process-orders-batch'];
    inventory100GetStock = exports1['demo:poly-erp/inventory@1.0.0#get-stock'];
    inventory100GetMemoryStats = exports1['demo:poly-erp/inventory@1.0.0#get-memory-stats'];
  })();
...
const inventory100 = {
  ...
  getStock: getStock,
  processOrdersBatch: processOrdersBatch,
  
};

export { inventory100 as inventory, inventory100 as 'demo:poly-erp/inventory@1.0.0',  }